...
activities = {
    ...
    "Basketball Club": {
        "description": "Pickup games, drills, and seasonal competitions",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Return updated activity so frontend can update UI without full page refresh
    return {"message": f"Signed up {email} for {activity_name}", "activity": activity}
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    # Return updated activity so frontend can update UI without full page refresh
    return {"message": f"Unregistered {email} from {activity_name}", "activity": activity}
